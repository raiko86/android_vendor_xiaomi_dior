...
# Prebuilt APKs (dior - V9.2.3.0.KHIMIEK)
PRODUCT_PACKAGES += \
    TimeService
...
# Camera fw (XT1068 - MPB24.65-34-3)
PRODUCT_COPY_FILES += \
...
# libchromatix* (dior - V9.2.3.0.KHIMIEK) + (XT1068 - MPB24.65-34-3)
...
# libactuator* (dior - V9.2.3.0.KHIMIEK)
...
# Sensors (TheMuppets Xiaomi cancro) sensors.msm8226.so Hex edited from sensors.msm8974.so
PRODUCT_COPY_FILES += \
...
# Time services (dior - V9.2.3.0.KHIMIEK)
PRODUCT_COPY_FILES += \
    vendor/xiaomi/dior/proprietary/bin/time_daemon:system/bin/time_daemon

# Venus (media) firmware (dior - V9.2.3.0.KHIMIEK)
PRODUCT_COPY_FILES += \
...
PRODUCT_COPY_FILES += \
    ...
    vendor/xiaomi/dior/proprietary/vendor/lib/libwvdrm_L1.so:system/vendor/lib/libwvdrm_L1.so \
    vendor/xiaomi/dior/proprietary/vendor/lib/libwvm.so:system/vendor/lib/libwvm.so \
    vendor/xiaomi/dior/proprietary/vendor/lib/libWVStreamControlAPI_L1.so:system/vendor/lib/libWVStreamControlAPI_L1.so

# Wifi (dior - V9.2.3.0.KHIMIEK)
PRODUCT_COPY_FILES += \
